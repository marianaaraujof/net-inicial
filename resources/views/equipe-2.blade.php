...
<div class="container-fluid box-geral-1">
    ...
    <div class="container-fluid-1"> 
        ...
        <h3 class="text-equipe text-left"> Esta é a equipe que, atualmente, compõe a Escola de Programação do LAIS. 
        ...
        Toda a equipe trabalha em conjunto a fim de obter aprendizados mútuos e diversos.    </div>
    ...
    <!-- Informações de Pierre -->
        <div class="row">
            ...
            <div class="main">
                <h4 class="mt-0">Pierre Freire</h4>
                ...
                <p class="texto-pessoa justify">Tecnólogo em Sistemas para Internet pela UNIVALI - Itajaí/SC, 
        ...
        <div class="row">
            ...
            <div class="main">
                <h4 class="mt-0">Danieli Rabelo</h4>
                ...
                <p class="texto-pessoa justify">Pesquisadora do Laboratório de Inovação Tecnológica em Saúde - LAIS/HUOL/UFRN. 
    ...
    <div class="box-geral-2">
        ...
        <div class="row">
            ...
            <div class="main">
                ...
                <p class="texto-pessoa justify">Cursa o Bacharelado em Design pela Universidade Federal do Rio Grande do Norte.
        ...
        <div class="row">
            ...
            <div class="main">
                <h4 class="mt-0">Deyvison Silas</h4>
                <a class="btn btn-light"><img class="img-box-atuacao" src="{{ asset('imgs/Curso_icon.svg') }}"> &nbsp Design</a>
                ...
                <p class="texto-pessoa justify">Aluno na Universidade Federal do Rio Grande do Norte (UFRN); graduando em design. Pesquisador e Designer na Base de Pesquisa Escola de Programação do Laboratório de Inovação Tecnológica em Saúde (LAIS).
        ...
        <div class="row">
            ...
            <div class="main">
                ...
                <p class="texto-pessoa justify">Técnico em Informática pelo Instituto Federal de Educação, Ciência e Tecnologia do Rio Grande do Norte (IFRN), campus Pau dos Ferros. 
        ...
        <div class="row">
            ...
            <div class="main">
                <h4 class="mt-0">Gabriel Machado</h4>
                <a class="btn btn-light"><img class="img-box-atuacao" src="{{ asset('imgs/Curso_icon.svg') }}"> &nbsp Desenvolvimento </a>
                ...
                <p class="texto-pessoa justify">Graduando do Bacharelado em Ciências e Tecnologia com ênfase em Engenharia de Materiais (UFRN). 
        ...
        <div class="row">
            ...
            <div class="main">
                <h4 class="mt-0">Hercules Pedrosa</h4>
                <a class="btn btn-light"><img class="img-box-atuacao" src="{{ asset('imgs/Curso_icon.svg') }}"> &nbsp Desenvolvimento</a>
                ...
                <p class="texto-pessoa justify">Graduando em Engenharia Biomédica (UFRN). Bacharel em Ciências e Tecnologia com ênfase em Tecnologia Biomédica (UFRN). 
        ...
        <div class="row">
            ...
            <div class="main">
                ...
                <a href="mailto:pierre.freire@lais.huol.ufrn.br" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="pierre.freire@lais.huol.ufrn.br" ><img class="img-box-atuacao" src="{{ asset('imgs/email_icon.svg') }}"></a>
                <p class="texto-pessoa justify">Graduando do Bacharelado em Ciências e Tecnologia(UFRN). 
                Pesquisador do Laboratório de Inovação Tecnológica em Saúde (LAIS/HUOL/UFRN).</p>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="main">
                <h4 class="mt-0">Mariana Araújo</h4>
                <a class="btn btn-light"><img class="img-box-atuacao" src="{{ asset('imgs/Curso_icon.svg') }}"> &nbsp Desenvolvimento</a>
                ...
                <p class="texto-pessoa justify">Graduanda do Bacharelado em Ciências e Tecnologia com Ênfase em Tecnologia Mecânica (UFRN).
        ...
        <div class="row">
            ...
            <div class="main">
                <h4 class="mt-0">Matheus Coutinho</h4>
                <a class="btn btn-light"><img class="img-box-atuacao" src="{{ asset('imgs/Curso_icon.svg') }}"> &nbsp Desenvolvimento</a>
                ...
                <p class="texto-pessoa justify">Graduando em Engenharia Mecânica (UFRN). 
        ...
        <div class="row">
            ...
            <div class="main">
                <h4 class="mt-0">Matheus Oliveira</h4>
                <a class="btn btn-light"><img class="img-box-atuacao" src="{{ asset('imgs/Curso_icon.svg') }}"> &nbsp Desenvolvimento</a>
                ...
                <p class="texto-pessoa justify">Graduando em Engenharia Biomédica (UFRN). 
